...
if page == pages[5]:
    ...
    st.write("- GDP is a strong indicator of a country's wealth and plays an important role in people's happiness. "
    ...
    st.write("- Happiness is a multidimensional concept. While GDP is important, it’s not the only factor. Other elements like social support, freedom to make life choices, "
    ...
    st.write("- Countries with high happiness scores may still face issues like depression or social inequality. "
    ...
    st.write("- Happiness can be affected by cultural factors, mental health, and other social dynamics, "
            "meaning that economic success does not always equate to emotional fulfillment for everyone.")
    
    st.write("- In short, while GDP contributes to happiness, it is essential to recognize the diverse factors that influence people’s well-being, making it a nuanced and complex topic.")
